    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Add(CategoryAddDto categoryAddDto)
        {
            ...
            if (result.IsValid)
            {
               await categoryService.CreateCategoryAsync(categoryAddDto);
                toast.AddSuccessToastMessage(Messages.Category.Add(categoryAddDto.Name), new ToastrOptions { Title = "Yupi" });
        ...
        public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.Category.Update(name), new ToastrOptions { Title = "Yupi" });
                return RedirectToAction("Index", "Category", new { Area = "Admin" });
            }
        ...
        public async Task<IActionResult> Delete(Guid categoryId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.Category.Delete(name), new ToastrOptions { Title = "Yupi" });
        ...
        public async Task<IActionResult> UndoDelete(Guid categoryId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.Category.UndoDelete(name), new ToastrOptions { Title = "Yupi" });
