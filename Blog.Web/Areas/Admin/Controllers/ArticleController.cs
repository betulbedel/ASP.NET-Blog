    ...
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Add(ArticleAddDto articleAddDto)
        {
            ...
            if (result.IsValid)
            {
               await articleService.CreateArticleAsync(articleAddDto);
                toast.AddSuccessToastMessage(Messages.Article.Add(articleAddDto.Title), new ToastrOptions { Title="Yupi"});
        ...
        public async Task<IActionResult> Update(ArticleUpdateDto articleUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.Article.Update(title), new ToastrOptions { Title = "Yupi" });
                return RedirectToAction("Index", "Article", new { Area = "Admin" });
            }
        ...
        public async Task<IActionResult> Delete(Guid articleId)
        {
           ...
           toast.AddSuccessToastMessage(Messages.Article.Delete(title), new ToastrOptions { Title = "Yupi" });
        ...
        public async Task<IActionResult> UndoDelete(Guid articleId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.Article.UndoDelete(title), new ToastrOptions { Title = "Yupi" });
