...
namespace Blog.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(IUserService userService, UserManager<AppUser> userManager,RoleManager<AppRole> roleManager, IImageHelper imageHelper, IValidator<AppUser> validator ,IToastNotification toast, SignInManager<AppUser> signInManager , IMapper mapper)
        {
