...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20230831134253_SeedCompleted")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a3c292a2-88a9-4c99-b762-9ce33e1d7d69"),
                            CategoryId = new Guid("7418fb6d-17c3-486e-93f6-0623c7b98730"),
                            Content = "Ypay zeka dunyayı yok edior",
                            CreatedBy = "betus",
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(687),
                        ...
                        new
                        {
                            Id = new Guid("e0d6158d-c109-426d-85f4-70b520ca5135"),
                            CategoryId = new Guid("17ea0da3-f0af-40fd-aeb9-62436552b0c6"),
                            Content = "Ypay zeka dunyayı yok etmiot",
                            CreatedBy = "betus2",
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(693),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(858),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(860),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "betus test",
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(961),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "betus test2",
                            CreatedDate = new DateTime(2023, 8, 31, 16, 42, 53, 564, DateTimeKind.Local).AddTicks(966),
